            ...
            @foreach($photos as $photo)
                <div class="flex-col bg-white rounded-lg border-2 my-2 p-2 ">
                    ...
                    <div class="gallery" id="photoGallery">  <!-- photo -->
                        ...
                        @elseif($photo->number > 1 && $photo->number <= 2)  <!-- 2 photos view-->
                            <div class="grid gap-0 grid-cols-1">
                                @isset($photo->link1)
                                    <div class="aspect-ratio-2/1 flex flex-col overflow-hidden border bg-white">
                        ...
                        @elseif($photo->number > 2 && $photo->number <= 4)  <!-- 4 photos view-->
