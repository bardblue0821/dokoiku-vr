  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <section class="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row">
      ...
      <div class="flex flex-col justify-center sm:text-center lg:py-12 lg:text-left xl:w-5/12 xl:py-24">
        <p class="mb-4 font-semibold text-teal-500 md:mb-6 md:text-lg xl:text-xl">さて……</p>

        <h1 class="mb-8 text-4xl font-bold text-black sm:text-5xl md:mb-12 md:text-6xl">「次どこいく？」</h1>

        <p class="mb-8 leading-relaxed text-gray-500 md:mb-12 lg:w-4/5 xl:text-lg">おすすめのワールドある？<br>みんなで行きたいワールド、行ってよかったワールドを共有しよう！</p>
  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <div class="grid gap-8 sm:grid-cols-2 md:gap-12 xl:grid-cols-3 xl:gap-16">
      ...
      <div class="flex gap-4 md:gap-6">
        ...
        <div>
          <h3 class="mb-2 text-lg font-semibold md:text-xl">おやすみワールド検索(予定)</h3>
          <p class="mb-2 text-gray-500">QVペンタグ、ジョインログ、ベッド、動画プレイやタグを活用して、おやすみワールドデータベースを作ろう！</p>
        </div>
      </div>
      <!-- feature - end -->
      ...
      <div class="flex gap-4 md:gap-6">
        ...
        <div>
          <h3 class="mb-2 text-lg font-semibold md:text-xl">写真投稿(予定)</h3>
          <p class="mb-2 text-gray-500">いい写真取れた！？ぜひみんなに共有しよう！</p>
        </div>
      </div>
      <!-- feature - end -->
    </div>
