        ...
        <footer class="mx-auto max-w-screen-2xl px-4 md:px-8">
            <div class="flex flex-col items-center border-t pt-6">
                ...
                <div class="flex gap-4">
                    ...
                    <a href="https://github.com/bardblue0821/test-project2" target="_blank" class="text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-600">
                        <svg class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="py-8 text-center text-sm text-gray-400">© 2023 - MonKupo. All rights reserved.</div>
        </footer>
    </div>
