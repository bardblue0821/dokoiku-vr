    ...
    <div class='max-w-7xl mx-auto px-6'>
        ...
        <form method='post' action="{{route('post.store')}}" enctype='multipart/form-data'>
            ...
            <div class='w-full flex flex-col'>
                <label for='title' class='font semibold mt-4'>ワールド名 World name</label>
                <input type='text' name='title' class='w-auto py-2 border border-gray-300 rounded-md' id='title' value="{{old('title')}}">
                <x-input-error :messages="$errors->get('title')" class="mt-2" />
            </div>

            <div class='w-full flex flex-col'>
                <label for='title' class='font semibold mt-4'>ジャンル World type</label>
                <input type='text' name='title' class='w-auto py-2 border border-gray-300 rounded-md' id='title' value="{{old('title')}}">
                <x-input-error :messages="$errors->get('type')" class="mt-2" />
            </div>
            
            <div class='w-full flex flex-col'>
                <label for='body' class='font-semibold mt-4'>何したい？ Comment etc.</label>
            ...
            <div class='w-full flex flex-col'>
                ...
                <label for='body' class='font-semibold mt-4'> 画像があればぜひ </label>
