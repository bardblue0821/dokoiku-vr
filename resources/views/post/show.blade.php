            ...
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                    ...
                    <div class="flex border-t border-gray-200 py-2">
                        ...
                        <span class="ml-auto text-gray-900">景観 Landscape</span>
                    </div>
                    <div class="flex border-t border-gray-200 py-2">
                    ...
                    <div class="flex py-4">
                        ...
                        <button class="flex ml-auto text-white bg-teal-500 border-0 py-2 px-6 focus:outline-none hover:bg-teal-600 rounded">VRChat サイトへ</button>
