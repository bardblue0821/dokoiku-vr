    ...
    <div class="bg-white py-6 sm:py-8 lg:py-12">
        <div class="mx-auto max-w-screen-2xl md:px-8 px-4">
            ...
            <div class="flex pt-4">
                ...
                <div class="flex items-center justify-center mt-2 ml-2 hover:mt-0                     duration-300 px-4 bg-teal-400        rounded-t"><a href="{{ route('users.show', ['id' => $user->id, 'info' => 'wannavisit_world']) }}"><div class="lg:text-base text-sm text-white    font-bold items-center justify-center px-2 py-2">行きたいワールド: {{$wannavisits_N}}</div></a></div>
