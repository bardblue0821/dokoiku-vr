...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('posts', function (Blueprint $table) {
            ...
            foreach ($records as $record) {
                $link = $record->link;
                $thumbnailLink = $this->getThumbnailLinkFromAPI($link);

                $record->update(['thumbnail' => $thumbnailLink]);
            }
        });
    }
    ...
    private function getThumbnailLinkFromAPI($link)
    {
        ...
        return $world_data['thumbnailImageUrl'];
    }
};
